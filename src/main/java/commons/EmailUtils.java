...
public class EmailUtils {
	...
	public EmailUtils(String username, String password, String server, EmailFolder emailFolder)
		 ...
		 * props.put("mail.imaps.ssl.trust", "*"); props.put("mail.smtp.ssl.trust",
		 * "*");
		 */		
	...
	public String getVerificationCode() throws Exception {
		Message[] emails = getMessagesBySubject("IPI Web Portal Login- Verification Code", true, 5);
		...
		int index = result.indexOf("<strong>");
		//System.out.println("index: " + index);
		String code = result.substring(index + 8, index + 13);
